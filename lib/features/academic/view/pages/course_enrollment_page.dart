...
import 'degree_program_enrollment_page.dart';
...
class CourseEnrollmentPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _CourseEnrollmentPageState();
}
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text(widget.course.title,style: context.textTheme().titleMedium?.copyWith(fontWeight: FontWeight.w700)),
            //Name Field
      ...
      child: ElevatedButton(
          onPressed:() async{
            if(_formKey.currentState?.validate() == true){
              await ref.read(academicEnrollmentVM.notifier).enrollCourse(
